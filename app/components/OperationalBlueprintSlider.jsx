...
const OperationalBlueprintSlider = () => {
  ...
  return (
    <section className="bg-white py-12">
      <div className="flex-col items-center justify-center max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-2xl text-[#1f2937] font-bold mb-6">
          The Operational Blueprint of Forgebyte
        </h2>
        <div className=' flex items-center justify-center'>
          <div className="flex items-center justify-between gap-6 relative w-[750px] px-4 py-6">
            {/* Left Button */}

            <button
              className="absolute left-1 bg-gray-300 hover:bg-gray-400 p-2 rounded-full z-10"
            ...
            {/* Right Button */}
            <button
              className="absolute right-1 bg-gray-300 hover:bg-gray-400 p-2 rounded-full z-10"
